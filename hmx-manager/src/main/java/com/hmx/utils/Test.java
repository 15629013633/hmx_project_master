...
public class Test {
    public static void main(String[] arg0){
        ...
        MesgPush mesgPush = new MesgPush();
        Gson gson=new Gson();
        mesgPush.setContentDes("哈哈");
        mesgPush.setContentImage("https://www.baidu.com");
        mesgPush.setContentId(12);
        mesgPush.setContentTpye(3);
        mesgPush.setTitle("标题");
        String json=gson.toJson(mesgPush);
